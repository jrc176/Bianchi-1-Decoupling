...
\delta R_{i0}&=-\ps{\p{\scr H+\f{\sigma_{ii}}{\gamma_{ii}}}\partial_iE_i}'-\f12\partial_i\p{\f{h_{ii}}{\gamma_{ii}}}'+\f12\partial_i\sum_k\partial^k\partial_k\p{E_k-E_i}-\p{4\scr H+\f{\sigma_{ii}}{\gamma_{ii}}}\partial_i A\\&-\p{\scr H+\f{\sigma_{ii}}{\gamma_{ii}}}\p{5\scr H}\partial_iE_i+\f{(S\partial_iE_i)'}{S\gamma_{ii}}\,,
\end{align}
