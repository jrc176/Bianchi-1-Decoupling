...
\delta R_{i0}&=-\ps{\p{\scr H+\f{\sigma_{ii}}{\gamma_{ii}}}\partial_iE_i}'-\f12\partial_i\p{\f{h_{ii}}{\gamma_{ii}}}'+\f12\partial_i\sum_k\partial_k\partial_k\p{E_k-E_i}-\p{4\scr H+\f{\sigma_{ii}}{\gamma_{ii}}}\partial_i A\\&-\p{\scr H+\f{\sigma_{ii}}{\gamma_{ii}}}\p{5\scr H}\partial_iE_i+\f{(S\partial_iE_i)'}{S\gamma_{ii}}\,,
\end{align}
A brief glance at the form of $\delta R_{ij}$ reveals that it too contains every GIV. Note, however, that $E,F,G$ only show up as first derivatives in $\eta$.
\end{document}
