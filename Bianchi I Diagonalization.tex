...
\notag\delta R_{ij}&=\delta_{ij}\ps{\p{\f{\p{S^2h_{ii}}'}{2S^2}}'+2\p{\scr H+\f{\sigma_{ii}}{\gamma_{ii}}}\p{-\f32 A'-2\p{\scr H+\f{\sigma_{ii}}{\gamma_{ii}}}\gamma_{ii}A+h_{ii}'+\p{\scr H-\f{\sigma_{ii}}{\gamma_{ii}}}h_{ii}-\f12\sum_k\partial_k\partial_k E_k}\right.\\&\left.-2\p{\scr H\gamma_{ii}+\sigma_{ii}}'A-2\scr H\p{\f{h_{ii}}{\gamma_{ii}}}'-\sum_k\partial_k\partial_k h_{ii}}+\partial_i\partial_j\ps{A+E_i+E_j+\f1{2\gamma_{ii}}\p{h_{ii}-2\sigma_{ii}E_j}+\f1{2\gamma_{jj}}\p{h_{jj}-2\sigma_{jj}E_i}}
\end{align}
